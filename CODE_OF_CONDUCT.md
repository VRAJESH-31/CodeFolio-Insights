...
1. **Correction**  
   A private, written warning describing the violation and explaining why the behavior was inappropriate.

2. **Warning**  
   A warning with consequences for continued behavior.

3. **Temporary Ban**  
   A temporary ban from contributing or interacting with the project.
