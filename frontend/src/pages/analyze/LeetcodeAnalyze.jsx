                        ...
                        <div className="w-full mx-auto p-6 bg-white/90 backdrop-blur-sm rounded-3xl shadow-2xl border border-white/60 space-y-8 animate-float-in">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div className="bg-blue-50/50 p-4 rounded-2xl border border-blue-100">
                                    ...
                                    <ul className="text-xs text-blue-700 space-y-1"><li>• Detailed problem stats</li><li>• Strengths & weaknesses</li><li>• AI recommendations</li></ul>
                                </div>
                                <div className="bg-purple-50/50 p-4 rounded-2xl border border-purple-100">
                                    ...
                                    <ul className="text-xs text-purple-700 space-y-1"><li>• Topic mastery</li><li>• Consistency tracking</li><li>• Difficulty breakdowns</li></ul>
                                </div>
                            </div>

                            <button
                                onClick={handleAnalyze} disabled={!userId || isFetching}
