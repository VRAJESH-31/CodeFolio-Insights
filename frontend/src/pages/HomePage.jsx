...
const App = () => {
    ...
    const handleLogout = async () => {
        ...
        // 3. Redirect the user to the landing page
        navigate('/');
    };
            ...
            <aside className={`hidden md:flex flex-col bg-white border-r border-gray-200 shadow-sm transition-all duration-500 ease-in-out ${isSidebarCollapsed ? 'w-20' : 'w-72'}`}>
                        ...
                        {sidebarItems.map((item) => (
                             <li key={item.name} className="relative">
                                <a 
                                    ...
                                    className={`flex items-center p-3 text-gray-700 rounded-xl group transition-all duration-300 ease-out relative overflow-hidden ${
                                ...
                                >
                                    ...
                                    <div className={`relative z-10 transition-all duration-300 ${
                                        ...
                                        <i className={`${item.icon} w-6 text-center text-xl transition-all duration-300 ${
                                            activeMenu === item.name 
                                                ? 'text-indigo-600' 
                                    ...
                                    {isSidebarCollapsed && (
                                        <div className={`absolute left-full ml-3 w-max px-3 py-2 bg-gray-900 text-white text-sm rounded-lg shadow-xl z-50 transition-all duration-200 ${
                ...
                <div className="p-4 border-t border-gray-200">
                    <details className="group">
                        <summary className={`flex items-center list-none cursor-pointer p-2 rounded-xl hover:bg-gray-50 transition-all duration-300 ${
                            isSidebarCollapsed ? 'justify-center' : ''
                        }`}>
                            <div className={`relative transition-all duration-300 ${
                                isSidebarCollapsed ? 'scale-110' : 'scale-100'
                            }`}>
                                <img
                                    src="https://placehold.co/40x40/E9D5FF/4F46E5?text=AC"
                                    alt="User profile"
                            ...
                            {!isSidebarCollapsed && (
                                <>
                                    <div className="ml-3 overflow-hidden flex-1 min-w-0 animate-fade-in">
                                        <p className="text-sm font-semibold text-gray-800 truncate">Alex Chen</p>
                                        <p className="text-xs text-gray-500 truncate">Full Stack Developer</p>
                                    </div>
