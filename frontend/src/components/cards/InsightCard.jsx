...
const InsightCard = ({ title, points = [], Icon = null, PointIcon = null, className = '', listClass = 'space-y-3', iconBg, iconColor, pointIconColor, pointColor, titleColor = 'text-blue-800' }) => {
  return (
