...
const VerifyOTPForm = ({ email, otp, setOtp, onSubmit, isVerifying, onBack }) => {
  return (
    <div className="space-y-6 animate-fade-in-up">
      ...
      <form className="space-y-6" onSubmit={onSubmit}>
        ...
        <button type="button" onClick={onBack} className="w-full mt-4 flex items-center justify-center gap-2 py-3 text-sm font-bold text-slate-500 hover:text-slate-800 transition-colors group">
